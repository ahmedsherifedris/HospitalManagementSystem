...
Item {
    ...
    GridLayout {
        ...
        ComboBox {
            id: deptCombo
            model: mainWindow.hospital.deptsList
            displayText: mainWindow.hospital.deptsList[currentIndex].dept
        ...
        Button {
            ...
            onClicked: {
                bookingId = mainWindow.hospital.reception.bookOutPatient(
    ...
    function refreshModel(){
        doctorModel.clear()
        var opClinics = mainWindow.hospital.deptsList[deptCombo.currentIndex].opClinics
        var i
        for(i = 0; i < opClinics.length; i++){
            doctorModel.append( opClinics[i].doctors )
        }
        for(i = 0; i < doctorModel.count; i++){
